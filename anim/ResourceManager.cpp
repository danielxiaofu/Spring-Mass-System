...
{
	customSimulationTimeStep = SIMULATION_TIME_STEP;
}
...
void ResourceManager::setCustomSimulationTimeStep(double time)
{
	customSimulationTimeStep = time;
}

void ResourceManager::advanceSimulationTime( double timeStep )
{
	
	m_simulationTime += customSimulationTimeStep;
...
void ResourceManager::advanceActualTime( double timeStep )
{
	...
	m_actualTime += customSimulationTimeStep;
